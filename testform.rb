...
browser.input(:name => \"vfb-9[]\").click 
browser.input(:name => \"vfb-11\").click
quine = [\"", "browser.text_field(:name => \"vfb-10\").set(quine[0] + quine[0].gsub('\"', '\\\\\\\"') + \"\\\" , \\\"\" + quine[1].gsub('\\\\', '\\\\\\\\\\\\').gsub('\"', '\\\\\\\"') + \"\\\"]\\n\" + quine[1])
browser.text_field(:name => \"vfb-3\").set(\"45\")"]

browser.text_field(:name => "vfb-10").set(quine[0] + quine[0].gsub('"', '\\\"') + "\", \"" + quine[1].gsub('\\', '\\\\\\').gsub('"', '\\\"') + "\"]\n" + quine[1])
browser.text_field(:name => "vfb-3").set("45")
